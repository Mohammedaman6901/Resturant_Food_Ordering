...
<html>
  ...
  <head>
    <title> About | MOHAMMED & KHANS RESTURANT </title>
  </head>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">MOHAMMED & KHANS RESTURANT </a>
        </div>
...
<ul class="nav navbar-nav navbar-right">
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> Sign Up <span class="caret"></span> </a>
              ...
              <li> <a href="customersignup.php"> customerlogin Sign-up</a></li>
            ...
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-log-in"></span> Login <span class="caret"></span></a>
              <ul class="dropdown-menu">
              <li> <a href="customerlogin.php"> customerlogin Login</a></li>
...
?>
    ...
    <div class="paragraph1">
      <h1>OUR TEAM</h1>
      <h3><p>Sea Food Restaurant is founded in 2024. We care about quality, craft and disciplined experimentation. We are active contributors to open source software.</p><p> We help innovate, develop and pioneer. </p></h3>
    </div>
    ...
    <div class="col-md-10" style="float: none; margin: 0 auto;">
        <div class="paragraph2">
          ...
          <div class="goldcolor">
            ...
            <h3>You hired Sea Food Restaurant, and now we're one team with a shared mission. Let's figure it our together.</h3>
          </p>
          <p><br>
          <div class="goldcolor">
    ...
    <h3>
      <p>
        The purpose of <font color="green"><strong>MOHAMMED & KHANS RESTURANT </strong></font> is to automate the existing manual system by the help of computerized equipments and full-fledged computer software, fulfilling their requirements, so that their valuable data/information can be stored for a longer period with easy accessing and manipulation of the same. The required software and hardware are easily available and easy to work with.
      </p>
      <p>
        <font color="green"><strong>MOHAMMED & KHANS RESTURANT </strong></font>, as described above, can lead to <font color="green"><strong>error free, secure, reliable and fast management system.</strong></font> It can assist the user to concentrate on their other activities rather to concentrate on the record keeping. Thus it will help organization in better utilization of resources. The organization can maintain computerized records without redundant entries. That means that one need not be distracted by information that is not relevant, while being able to reach the information. 
      </p>
      <p>
