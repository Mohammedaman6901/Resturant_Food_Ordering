...
<html>
  ...
  <head>
    <title> Explore | Sea Food Restaurant </title>
  </head>
...
else
{
  ...
  <div class="container">
    <div class="jumbotron">
      <center>
         <label style="margin-left: 5px;color: red;"> <h1>Your Food is Here Order Now.</h1> </label>
        <p>Stay Hungry</p>
      </center>
...
<b><center><p> See Food Restaurant-2024 | &copy All Rights Reserved </p><center></b>