    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php"> Sea Food Restaurant</a>
        </div>
...
?>
    ...
    <p><br> 
      <h4>Our Restaurant branches are available at <font color="green"><strong>Shimoga</strong>, <strong>manglore</strong>, <strong>Banglore</strong></font> 
	   <font color="green"><strong>
	  </strong>.</font> While someone is asking to eat Fish Fry from <font color="green"><strong>manglore</strong></font>and they just loved it.
	                                                      THANK YOU FOR VISIT -<font color = "green">arbaazkhan9845@gmai.com
    ...
    <p><br> 
      <h4>
       Sea Food Restaurant will help in making your quest for enjoying good lunch, dinner which is are home delivered all the more interesting and excited when you are scartching your head to entertain your guest with their demands met.
      </h4>
    </p>
    <p>
      <h4>
        There are two ways you can <font color="green"><strong>order food online</strong></font> with us. <font color="green"><strong>Download  Sea Food Restaurant app on your smartphone</strong></font> or open our user friendly website and get it home delivered. Or if you are busy in your schedule and just want to eat at leisure at home you can order takeaway from host of restaurants and pickup the food parcel kept ready for you while you are on the way to home.
      </h4>
    </p>
    </di
    ...
    <div class="paragraph1">
          ...
          <p>
            <h4>
              You select as per your choice of restaurant from the list serving <font color="green"><strong>cuisines like Indian,south Indian, North Indian,</strong></font> Burgers or Desserts like Ice-cream or Cakes.
            </h4>
          </p>
          <br>
          <p>
          ...
          <p>
            <h4>
              That’s all once everything is in order hit on the checkout and pays online or cash on delivery,
			  choose the way you want we accept all major credit cards or pay cash on delivery. <font color="green"><strong>You can order 
			  food online in cities and areas like Shimoga,Manglore,Banglore.</strong></font>
            </h4>
          </p>
          <br>
          <p>
            <h4>
              Yes,  Sea Food Restaurant is another way to live life with our loved ones...
            </h4>
          </p>
      </div>
